  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <div className="mx-auto flex h-screen max-w-[1440px]">
        {/* Sidebar */}
        <aside className="hidden w-[297px] shrink-0 bg-[#FBFBFB] md:flex md:flex-col md:justify-between">
          <div className="px-6">
            {/* Top: brand + search */}
            ...
            {/* Today */}
            <div className="mt-4">
              <div className="px-2 pb-2 text-base font-bold tracking-wide">
                Today
              </div>
              <div className="flex flex-col gap-4">
                <ChatHistoryItem label="Helpful AI Ready" />
        ...
        <section className="relative flex min-w-0 flex-1 flex-col">
          ...
          {/* Icebreakers */}
          <div className="mx-auto w-full max-w-[928px] space-y-3">
            <IceBreaker
              left={
                <svg
                  width="48"
          ...
          {/* Bottom composer */}
          <div className="mx-auto mt-auto flex w-full max-w-[928px] gap-4 pt-12 pb-4">
            <TextInput
              leftIcon={
          ...
          {/* Disclaimer */}
          <div className="mx-auto mb-8 w-full max-w-[928px] text-center text-xs">
            <p>
              StormBot may produce inaccurate information about people, places,
              or fact. {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
              <a href="#">
